...
// get games list list
$sql = "SELECT G.GAME_ID, G.PUBLISH, SUBSTRING(G.START_DATE, 1, 16) START_DATE,
          T1.TEAM_NAME TEAM_NAME1, T2.TEAM_NAME TEAM_NAME2, SD.SEASON_TITLE
        FROM games G LEFT JOIN seasons S ON G.SEASON_ID=S.SEASON_ID                   
		     left JOIN seasons_details SD ON S.SEASON_ID = SD.SEASON_ID AND SD.LANG_ID=".$_SESSION['lang_id']."
...
$tpl->setTemplateFile('../tpl/adm/sched.tpl.html');
$tpl->addData($data);
echo $tpl->parse();
