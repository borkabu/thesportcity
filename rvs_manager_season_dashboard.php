...
// include common header
  ...
  $manager_season = $managerbox->getRvsManagerSummaryBox($auth);

//$managerbox->getManagerSeasonDashboardBox($manager->mseason_id, "rvs");
  ...
  $start = getmicrotime();
  $content .= $smarty->fetch('smarty_tpl/rvs_manager_season_dashboard.smarty');    
  $stop = getmicrotime();
  if (isset($_GET['debugphp']))
    echo 'smarty_tpl/rvs_manager_season_dashboard.smarty'.($stop-$start);
