...
<meta name="keywords" content="Sport city, fantasy manager, basketball fantasy manager, football fantasy manager, tennis fantasy manager, nba fantasy manager, euroleague fantasy manager, premier league fantasy manager, f1 fantasy manager, champions league fantasy manager" />
...
<?php echo $menu->getMenu(scriptName($_SERVER["PHP_SELF"]), "left", 150, 1, -13, 22) ?>
<?php echo $loginbox->getLoginBox($auth, false, true); ?>
<?php 
if ((!$auth->userOn() && !isset($facebook_user)) || ($auth->userOn() && !isset($facebook_user))) { ?>
...
<?php 
  ...
  include('inc/top_external_index.inc.php');
}  
